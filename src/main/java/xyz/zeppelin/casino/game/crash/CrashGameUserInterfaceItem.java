...
public class CrashGameUserInterfaceItem implements InventoryUserInterfaceItem {
    ...
    public CrashGameUserInterfaceItem(Plugin plugin) {
        this.plugin = plugin;
        ...
        CrashGame.Config config = mainConfig.getCrashConfig();
